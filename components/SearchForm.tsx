    ...
    return (
        <form onSubmit={handleSubmit} className="relative w-full max-w-2xl">
            <div className="relative group">
                ...
                <div className="relative flex items-center rounded-xl bg-black/80 p-2 ring-1 ring-white/10 backdrop-blur-xl">
                    ...
                    <button
                        ...
                        className="rounded-lg bg-white px-6 py-2.5 font-semibold text-black transition-transform hover:scale-105 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
                    >
                        {isLoading ? (
